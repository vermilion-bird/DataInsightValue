...
export const API_DOMAIN = 'http://144.24.77.244:3000'
...
export default class Request {
  ...
  static postJson(url : string, data: Record<string, any> = undefined, options: Record<string, any> = {}) {
  ...
  static request(url: string, options: Record<string, any> = {}) {
    ...
    return new Promise<any>((resolve, reject) => {
      return fetch(`${API_DOMAIN}/api/v1/${url}`, options)
        .then((response: any) => {
